      ...
      <div className="w-[60%] h-[120px] sm:min-h-[30px]  flex flex-row justify-end lg:justify-around  items-center">
        ...
        {isConnected ? (
          ...
          <button
            ...
            className="hidden lg:flex text-white text-[18px] md:text-[15px] md:font-semibold   w-[19%] h-[45px] bg-gradient-to-r from-[#2C004F] to-[#BD06FD] rounded-[18px] mr-[20px]  font-bold font-inter"
          >
            Connect Wallet
          </button>
        )}
